...
const commands = {
	...
	{
		cmd: 'members',
		res: 'Exploit Members:<span class="red"></span><br>#<span class="red"> Rezizt</span><br># <span class="red"> Con</span><br># <span class="red"> Fweak</span><br># <span class="red"> Zac</span><br># <span class="red"> Sin</span><br># <span class="red"> Razu</span><br># <span class="red"> Yaekith</span><br><br># Associates:<br>#<span class="red"> Vortex for the website <3</span><br>#<span class="red"> reizt.xyz for the website <3</span>'
	},
	aboutme:  
	{
		cmd: 'aboutme',
		res: 'About Me:<br># <span class="red">Real Name:</span>ass eater<br># <span class="red">Born:</span> ' + sMonth["6"] + ' 13 2000 <span class="red">(Age: ' + GetAge("2000-07-13") + ')</span><br># <span class="red">Country:</span> Your discord account<br><br><span class="red">Bio:</span><br><span class="pink"><br>Sup! Im rezizt, I code shit on discord and do exploits lol.<br>Im A Programmer And Server owner :D<br>But Most People Know Me From youtube :D<br></span><br># <span class="red">Programming:</span> HTML, CSS, JS, C#, PY, JAVA.<br></span><br><span class="red">Things i own:</span><br>- Youtube <span class="red">(Rezizt)</span><br>- Discord server <span class="red">(discord.gg/hoe)</span><br>- Aids <span class="red">(0-0)</span><br>- This website <span class="red">(duh)</span><br>- Ass <span class="red">(Yummy)</span>'
	},
	links: 
	{
		cmd: 'links',
		res: 'Links:<br># <span class="red"><a href="https://discord.gg/hoe" target="_blank"><u>Discord</u></a></span> - My Discord Account.<br># <span class="red"><a href="https://github.com/REZIZT1337" target="_blank"><u>Github</u></a></span> - Where i post my code<br># <span class="red"><a href="https://steamcommunity.com/id/Reziztzz" target="_blank"><u>Steam</u></a></span> - You can find me there <span class="green">Online</span> most of the time.<br># <span class="red"><a href="http://ratted.xyz" target="_blank"><u>My Downloads</u></a></span> - All Of My Downloads for youtube.</span><br># <span class="red"><a href="https://www.youtube.com/channel/UCgWSkoGwV_ith3m0NAbKoqg?view_as=subscriber" target="_blank"><u>Youtube</u></a></span> - Some trash content, I post there.<br># <span class="red"><a href="" target="_blank"><u></u></a></span>'
	},
	visitors: 
	{
		cmd: 'visitors',
	...
	{
		cmd: 'help',
		res: 'Available commands:<br><br># <span class="red">aboutme</span> - Some information about me.<br># <span class="red">clear</span> - Really, it just clear. <br># <span class="red">screenfetch</span> - Fetches system information in the terminal.<br># <span class="red">links</span> - Links for others sites.<br># <span class="red">music [play/stop/link]</span> - Just BG Music.<br># <span class="red">visitors</span> - How many times people visited this site.<br># <span class="red">insta [Link]</span> - Get original instagram picture.<br># <span class="red">members</span> - Shows all current Rezizt members.<br># <span class="red"></span>'
	}
}

var prephraseRoot = '<span class="red">root@reizt.xyz</span>:<span class="blue">~</span># ';
var prephrase = '<span class="red">visitor@reizt.xyz</span>:<span class="blue">~</span># ';
...
{
	var res = '';
	if (command === './welcome.sh') res = 'Welcome to <span class="red">reizt.xyz</span>!<br></span><br>Made By:</span><span class="red"> Rezizt</span><br>Total Visits: <span class="red">' + visits + '</span><br>Terminal Updated: <span class="red">' + lastUpdate +'</span><br><a href="" target="_blank"><u></u></a>:<span class="red"></span><br><br><b>Type \'help\' for more details on the commands</b>'
	else
	{
...
$('form').on('submit', function(e) {
	...
	try {
			...
			if (vInput.startsWith("./")) {
				if (vInput === "./root/welcome.sh") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>reizt.xyz: ' + vInput + ': No such file or directory</p></div>'
					});
				}
				...
				if (typeof loginArray[2] !== "undefined") {
					if (loginArray[2] === "visitor") {
						...
						res = 'reizt.xyz: No passwd entry for user ' + loginArray[2] + '';
					}
					launchCommandAsVisitor({
				...
				if (vInput === "music play") {
					...
					var win = window.open("https://soundcloud.com/alex-tomkins-12653165/nitonb-make-it-home-exclusive", "_blank");
					win.focus();
					launchCommandAsVisitor({
						cmd: vInput,
						res: ''
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="red">reizt.xyz</span> ] Usage: music [play/stop/link]</p></div>'
					});
				}
				...
				if (vInput === "friend joffrey") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="red">reizt.xyz</span> ] Usage: friend [name/list]</p></div>'
					});
				}
		...
		if (root > 0) {
			launchCommandAsRoot({
				cmd: $('input').val(),
				res: '<div><p>reizt.xyz: ' + $('input').val() + ': command not found</p></div>'
			});
		} else {
			launchCommandAsVisitor({
				cmd: $('input').val(),
